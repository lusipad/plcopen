...
| 文档 | 当年角色 |
|------|----------|
| [rewrite-plan.md](rewrite-plan.md) | 核心重写战略（R0-R4，已执行完毕；L0-L7 架构与出处纪律的原始出处） |
| [r0-r4-work-breakdown.md](r0-r4-work-breakdown.md) | 第 1 年重写冲刺的 issue 级拆解 |
| [r0-evidence-package.md](r0-evidence-package.md) / [r4-evidence-package.md](r4-evidence-package.md) | R0/R4 收口证据包（含 DoD §5.3 误归因与更正的完整记录） |
| [r3-migration-matrix.md](r3-migration-matrix.md) | R3 FB 迁移批次矩阵 |
