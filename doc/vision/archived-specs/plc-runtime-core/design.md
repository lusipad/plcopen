...
> **历史愿景归档（2024）**：本文记录早期 Uranus PLC Runtime 设想，不是
> 当前 `plcopen` 架构、能力或版本承诺。当前事实见根
> [STATUS](../../../../STATUS.md)、[ROADMAP](../../../../ROADMAP.md) 与
> [新核架构](../../../design/core/architecture.md)。文中未成文的计划项保留为
> 历史文字，不补造空白设计文档。
...
9. 调试系统设计（历史计划项，未单独成文）
10. 错误处理设计（历史计划项，未单独成文）

## 开发计划

当前开发计划和里程碑见项目根目录的 [ROADMAP](../../../../ROADMAP.md) 与
[STATUS](../../../../STATUS.md)；早期 `plan.md` / `MILESTONES.md` 从未作为
本仓库现行事实源。
