...
| [benchmark-trend-pipeline.md](benchmark-trend-pipeline.md) | E5 同机 base/head 基准趋势观测（四类指标、阈值、历史与安全边界） |
| [decisions/](decisions/) | ADR：0001 许可证策略 · 0002 C++17 · 0003 Ruckig oracle 边界 · 0004 Servo 适配器（Accepted）· 0005 人形多链模型（Accepted）· 0006 fieldbus 进程模型（Accepted，GPL 分发口径待人核验）· 0007 executor 承诺轨迹（Accepted；X5 IPC 后续见[合同](../compliance/executor-ipc-semantics.md)） |
