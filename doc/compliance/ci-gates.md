...
| Documentation | `.github/workflows/docs.yml` | `main` 分支 `docs/**`、`docs.zh/**`、`overrides/**` 或 `mkdocs*.yml` 变更、`workflow_dispatch` | 25 对中英文 Markdown 路径一一对应，英文正文拒绝中文叙述；中文根站与 `/en/` 英文站分别通过 MkDocs strict，项目/技术导读页回链权威仓库来源，深层页语言选择器保持对应路径，和 Doxygen API 拼装后一次推送 `gh-pages`；Pages 已启用（2026-07-11），站点 https://lusipad.com/plcopen/ | 文档发布门 |
