...
| [v0.20.0-release-draft.md](v0.20.0-release-draft.md) | v0.20.0 发布形式、已验证门禁与操作检查单；面向用户的发布记录见 [`docs/releases/v0.20.0.md`](../../docs/releases/v0.20.0.md) | 候选已验证，PyPI/GitHub 前置已配置，待授权 tag/发布 |
