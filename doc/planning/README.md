...
| [t2-mujoco-rerun-plan.md](t2-mujoco-rerun-plan.md) / [实施记录](t2-mujoco-rerun-implementation-notes.md) | T2a MuJoCo 物理闭环 + Rerun 离线记录首批，保持 H1/H2/L5 边界 | **规格草案待维护者批准（2026-07-23）** |
...
*本索引最后更新：2026-07-23（T2a 规格与实施计划送批）*
