...
| [h3-rnea-plan.md](h3-rnea-plan.md) / [实施记录](h3-rnea-implementation-notes.md) | H3 固定基座 1～8 关节 RNEA、独立 ABA/势能 oracle 与 48 关节预算门 | **已完成并合入，PR #35 与合入后五条主线工作流全绿（2026-07-26，KB-094）** |
