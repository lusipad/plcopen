...
| [h1-synchronized-joint-stream-plan.md](h1-synchronized-joint-stream-plan.md) | H1 48 关节原子混合命令帧、direct/upsample 延迟与组级断流实施基线 | **已批准，待实现（2026-07-25）** |
...
*本索引最后更新：2026-07-24（D1 主线与公网证据闭合，当前转入 H1）*
