...
Part 4 = 21/68 个同名门面、47 个无同名入口；Part 5 = 11/11 有 C++ 门面但仍部分覆盖。**认证的实质不是 FB 数量，是 B 级 I/O
的齐备性**（附录 B3）。
...
| 波 | 内容 | 量级 |
|----|------|------|
| P4-B1 | **管理与回读 19 项**：组参数/动态/SW限位/回读/运动学信息；旧“21 项”无法按标准清单复算，且部分需新增固定容量配置状态 | 1 L0 |
