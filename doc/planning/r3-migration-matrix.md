...
| single-axis management | R3.5 | `core/axis/state.h` plus `core/fb/motion.h` power, reset, readback snapshot, override, torque, limits; `core/fb/parameter.h` parameter registry reads/writes, status/error/value reads, set-position; `core/fb/probe.h` touch probe, abort trigger, emergency stop over the fixed trigger-input bank | `plcopen_core_r3_tests`; `plcopen_core_r3_parameter_tests`; `plcopen_core_r3_probe_tests`; Part 1/2 matrix rows remain authoritative |
