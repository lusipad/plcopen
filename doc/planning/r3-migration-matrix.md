...
| single-axis management | R3.5 | `core/axis/state.h` plus `core/fb/motion.h` power, reset, readback snapshot, override, torque, limits; `core/fb/parameter.h` parameter registry reads/writes, status/error/value reads, set-position; `core/fb/probe.h` touch probe, abort trigger, emergency stop over the digital-input bank; `core/fb/io.h` digital IO, digital cam switch, axis info, motion state | `plcopen_core_r3_tests`; `plcopen_core_r3_parameter_tests`; `plcopen_core_r3_probe_tests`; `plcopen_core_r3_io_tests`; Part 1/2 matrix rows remain authoritative |
...
| Part 4 linear | R3.8 | `AxisGroup::submit_linear` plus L6 linear absolute/relative facades for ACS 2-8 axis shared-path commands; `core/fb/group.h` group administration and readback facades | `plcopen_core_r3_tests`; `plcopen_core_r3_group_fb_tests`; `doc/compliance/plcopen-motion-part4-linear-matrix.md` |
