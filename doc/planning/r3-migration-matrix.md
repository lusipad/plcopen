...
| single-axis motion | R3.6 | `AxisModel::submit` and L6 facades for absolute, relative, additive, velocity, continuous absolute/relative, superimposed (+halt), home, halt, stop, torque | `plcopen_core_r3_tests`; `plcopen_core_r3_motion_family_tests`; R1 OTG tests; R2 sampler tests |
