...
| # | 批次 | 内容 | 前置 |
|---|------|------|------|
| D1 | LSP + VS Code 扩展 | **本地软件交付完成（2026-07-24，KB-092），远端门禁待闭合**：权威 C++ POU 工具索引 + 零第三方 Python stdio LSP + trusted-workspace 官方 VS Code client；固定 lock/许可证证据、本地 VSIX、双平台 workflow 与双语指南已落地，不做跨文件 IDE 或公共发布 | L0-L2（T40 容错前端为 L0 内置要求） |
