...
| 批 | 内容 | 量级 | 出口 |
|----|------|------|------|
| **P1-A** | Part 1 首批结构性缺口 4 项（MoveAbsolute.Direction / SetOverride 电平化 / Phasing 主从双轴 / DigitalCamSwitch 完整化） | 0.5 L0 | **进行中**：Direction 已关闭 D-05 的 B 级接口缺口（modulo 仍门控）；其余 3 项及 D-01~D-20 继续逐项清零 |
