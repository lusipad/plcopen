...
| 批 | 内容 | 量级 | 出口 |
|----|------|------|------|
| **P1-A** | Part 1 首批结构性缺口 4 项（MoveAbsolute.Direction / SetOverride 电平化 / Phasing 主从双轴 / DigitalCamSwitch 完整化） | 0.5 L0 | **仅关闭 B 级接口首批缺口**；仍须清零 D-01~D-20 后才具备声明条件 |
...
| P-GUIDE | 对照 Creating compliant FB libraries / Coding Guidelines / Software Quality Metrics / OOP / Annex A-E | 0.3 L0 | ✅ 审计完成；G-01~G-05 已登记，后续另批实现门禁/语言能力 |
