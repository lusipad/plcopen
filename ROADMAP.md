...
| 批 | 内容 | 量级 | 出口 |
|----|------|------|------|
| **P1-A** | Part 1 首批结构性缺口 4 项（MoveAbsolute.Direction / SetOverride 电平化 / Phasing 主从双轴 / DigitalCamSwitch 完整化） | 0.5 L0 | **进行中**：Direction/D-05、SetOverride/D-12 已关闭；Phasing 双轴与 DigitalCamSwitch 完整化继续，其他 D 项另批清零 |
