...
| 批 | 内容 | 量级 | 出口 |
|----|------|------|------|
| **P1-A** | Part 1 首批结构性缺口 4 项（MoveAbsolute.Direction / SetOverride 电平化 / Phasing 主从双轴 / DigitalCamSwitch 完整化） | 0.5 L0 | **进行中**：D-05/D-12/D-15 已关闭；仅 DigitalCamSwitch 完整化未完成，其他 D 项另批清零 |
